...
-- ── 햄모찌 초기 프로필 값 (한 번만 실행 · 이미 값이 있으면 덮어씀) ──
INSERT INTO profile (id, data) VALUES (1, '{
  "soop-id": "hammojji",
  "info-name": "햄모찌",
  "info-name-en": "HAMMOZZI",
  "info-reading": "햄모찌 / hammozzi",
  "info-catchphrase": "귀차니즘 때문에 가출한 햄스터 영물",
  "info-debut": "2026.01.06",
  "info-birth": "10.17",
  "info-fandom": "꾹꾹이",
  "info-agency": "개인세",
  "info-gender": "여",
  "info-motif": "하트, 리본, 햄스터, 방울",
  "info-tags": "햄스터영물, 소통, 종겜, 꾹꾹이, 개인세",
  "info-game": "마크, 배그, 롤",
  "info-genre": "J-POP · K-POP",
  "info-avoid": "고음 곡",
  "info-signature": "음율 - 절망 속에서 춤을 추어라",
  "info-song": "가끔 노래해요",
  "info-content": "소통 · 종합게임",
  "sched-weekday": "평일 오후 3시",
  "sched-weekend": "주말 오후 6시",
  "bgm-title": "말랑한 꿈의 행진곡",
  "like-list": "디저트, 고양이",
  "dislike-list": "벌레, 채소",
  "days": "0,1,2,3,4,5,6",
  "link-soop": "https://www.sooplive.com/station/hammojji",
  "link-x": "https://x.com/mojji81290",
  "link-discord": "https://discord.gg/pH8bUYjHqb",
  "theme-main": "#FFEE9C",
  "theme-main-dark": "#A8801F",
  "theme-main-deep": "#8A6A18",
  "theme-main-light": "#FFFBE0",
  "theme-bg": "#FFF9E8",
  "theme-logo": "#8B6FC4"
}'::jsonb)
